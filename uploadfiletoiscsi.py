...
"""
    ...
    vmware_guest - reference
    https://code.vt.edu/nis-ansible-roles/upstream-ansible/blob/7603ae33b574893a8afcfa1fb680a19380658d12/lib/ansible/modules/cloud/vmware/vmware_guest.py
"""
import os
import requests
