...
set DR_TXT_VCHOSTNAME=RPW_VCHOSTNAME
...
:: Plugin-ID
set DR_TXT_EXTKEY=RPW_EXTKEY

:: Organization
set DR_TXT_PLUGIN_COMPANY=RPW_COMPANY

:: Description 
set DR_TXT_PLUGIN_DESC=RPW_DESC
...
set DR_TXT_CERTPWD=RPW_CERTPWD
...
set DR_TXT_CERTORG=RPW_CERTORG

::Certificate Organization Unit <---------REQUIRE EDITING BY USER
set DR_TXT_CERTORGUNIT=RPW_CERTORGUNIT
...
set DR_SERVICE_ACCOUNT_NAME=%DR_CB_HOSTNAME%\Administrator
