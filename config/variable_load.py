...
basename = jdata['configuration']['basename']
esxi_cpu = jdata['nested']['esxi']['config']['cpu']
# esxi_mem = jdata['nested']['esxi']['config']['mem']
# esxi_version = jdata['nested']['esxi']['config']['esxversion']
# esxi_rootpw = jdata['nested']['esxi']['config']['rootpw']
